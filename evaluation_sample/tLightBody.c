 ...
 *   gen/tLightBody_templ.c => src/tLightBody.c
...
/* #[<ENTRY_FUNC>]# eLight_main
 * name:         eLight_main
 * global_name:  tLightBody_eLight_main
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eLightBody_main(CELLIDX idx)
{
	CELLCB	*p_cellcb;
	if (VALID_IDX(idx)) {
...
/* #[<ENTRY_PORT>]# eLightTask
 * entry port: eLightTask
 * signature:  sTaskBody
 * context:    task
 * #[</ENTRY_PORT>]# */

/* #[<ENTRY_FUNC>]# eLightTask_main
 * name:         eLightTask_main
 * global_name:  tLightBody_eLightTask_main
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eLightTask_main(CELLIDX idx)
{
	CELLCB	*p_cellcb;
	if (VALID_IDX(idx)) {
		p_cellcb = GET_CELLCB(idx);
