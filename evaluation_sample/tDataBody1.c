 ...
 *   gen/tDataBody_templ.c => src/tDataBody.c
 ...
 *   void           cMotor_main( );
 * call port: cLight signature: sLight context:task optional:true
 *   bool_t     is_cLight_joined()                     check if joined
 *   void           cLight_main( );
...
/* #[<ENTRY_FUNC>]# eData_main
 * name:         eData_main
 * global_name:  tDataBody_eData_main
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
 ...
 * name:         eDataTask_main
 * global_name:  tDataBody_eDataTask_main
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eDataTask_main(CELLIDX idx)
{
	...
	/* Put statements here #_TEFB_# */
	syslog(LOG_NOTICE, "DataTask1 is running!");
	dly_tsk(4000);
}
