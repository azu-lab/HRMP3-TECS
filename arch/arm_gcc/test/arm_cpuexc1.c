 ...
 *  の責任を負わない．
 * 
 *  $Id: arm_cpuexc1.c 866 2021-02-22 06:17:19Z ertl-hiro $
 */
 ...
 * 【テストの目的】
 *
 *  ARMコア依存部のCPU例外処理をテストする．未定義命令，プリフェッチア
 *  ボート，データアボートに対して，CPU例外処理のテスト(6)とCPU例外処
 *  理のテスト(5)の状況を連続してテストする．また，フェイタルデータア
 *  ボートに対して，CPU例外処理のテスト(6)の状況でテストする．
 *
 ...
 *		assert(xsns_dpn(p_excinf) == true)					... (2-G)
 *	23:	DO(PREPARE_RETURN_CPUEXC_PABORT)
 *		RETURN
 *	== TASK1-3（続き）==
 ...
 *	== CPUEXC5 ==
 *	38:	state(true, true, false, true, false)				... (3-A)
