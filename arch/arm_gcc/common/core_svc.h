 ...
 *  の責任を負わない．
 * 
 *  $Id: core_svc.h 507 2019-10-30 05:17:41Z ertl-hiro $
 */
 ...
 *
 *  サービスコールのパラメータ（最大5つ）をr0〜r4に，機能コードをr5に
 *  入れて，svc命令を発行する．r12は壊される．r4〜r11は保存される．
 */
