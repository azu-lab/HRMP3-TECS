...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (DOM1), (TA_NULL), (EXINF)(1), (TASK)(task1_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK1, ROUND_STK_T(4096), _kernel_ustack_TASK1, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) }, 1, 0x1U },
	{ (DOM1), (TA_NULL), (EXINF)(1), (TASK)(task0_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK1_0, ROUND_STK_T(4096), _kernel_ustack_TASK1_0, { TACP(DOM1), TACP(DOM1), TACP(DOM1), TACP(DOM1) }, 1, 0x1U },
	{ (DOM2), (TA_NULL), (EXINF)(1), (TASK)(task2_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK2, ROUND_STK_T(4096), _kernel_ustack_TASK2, { TACP(DOM2), TACP(DOM2), TACP(DOM2), TACP(DOM2) }, 1, 0x1U },
	{ (DOM2), (TA_NULL), (EXINF)(1), (TASK)(task0_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(DEFAULT_SSTKSZ), _kernel_sstack_TASK2_0, ROUND_STK_T(4096), _kernel_ustack_TASK2_0, { TACP(DOM2), TACP(DOM2), TACP(DOM2), TACP(DOM2) }, 1, 0x1U },
	{ (TDOM_KERNEL), (TA_NULL), (EXINF)(1), (TASK)(task3_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TASK3, 0, NULL, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }, 1, 0x1U },
	{ (TDOM_KERNEL), (TA_NULL), (EXINF)(1), (TASK)(task0_1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TASK3_0, 0, NULL, { TACP_KERNEL, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL }, 1, 0x1U }
};
...
const DOMINIB _kernel_dominib_table[TNUM_DOMID] = {
	...
	{ TACP(DOM2), { &_kernel_schedcb_idle_prc1, NULL, NULL, NULL }, { _kernel_tmevt_heap_kernel_prc1, NULL, NULL, NULL }, { TACP(DOM2), TACP(DOM2), TACP_KERNEL, TACP(DOM2) } }
};
