 ...
 * 
 *  Copyright (C) 2018-2022 by Embedded and Real-Time Systems Laboratory
 ...
 *  の責任を負わない．
 * 
 *  $Id: cfg_common.h 999 2022-11-21 13:47:01Z ertl-hiro $
 */
...
extern MPF_T mpf_MPF3[];
extern MPF_T mpf_MPF6[];
...
extern const intptr_t nvar3;
extern volatile intptr_t nvar4;
extern volatile intptr_t nvar5;
extern volatile intptr_t nvar6;
...
extern void	task0_1(EXINF exinf);
extern void	task1_1(EXINF exinf);
extern void	task2_1(EXINF exinf);
extern void	task3_1(EXINF exinf);
extern void	task4_1(EXINF exinf);
extern void	task5_1(EXINF exinf);
...
extern void	cyclic5_handler(EXINF exinf);
...
extern void	alarm4_handler(EXINF exinf);
