...
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	{ (TDOM_KERNEL), (TA_ACT), (EXINF)(1), (TASK)(task1), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_sstack_TASK1, 0, NULL, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, 1, 0x1U },
	{ (TDOM_KERNEL), (TA_NULL), (EXINF)(2), (TASK)(task2), INT_PRIORITY(HIGH_PRIORITY), STACK_SIZE, (void *)(stack_TASK2), 0, NULL, { TACP_SHARED, TACP_KERNEL, TACP_KERNEL, TACP_SHARED }, 1, 0x1U }
};
...
const CYCINIB _kernel_cycinib_table[TNUM_CYCID] = {
	...
	{ (TA_STA), (intptr_t)(&nvar1), _kernel_cychdr_CYC2, (1000), (1000), { TACP_SHARED, TACP_KERNEL, TACP_KERNEL, TACP_SHARED }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(&nvar2), _kernel_cychdr_CYC3, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_cychdr_CYC4, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_cychdr_CYC5, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(SEM1), _kernel_cychdr_CYC6, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(FLG1), _kernel_cychdr_CYC7, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(DTQ1), _kernel_cychdr_CYC8, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_cychdr_CYC9, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_cychdr_CYC10, (1000), (1000), { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 }
};
...
const ALMINIB _kernel_alminib_table[TNUM_ALMID] = {
	...
	{ (TA_NULL), (intptr_t)(&nvar1), _kernel_almhdr_ALM2, { TACP_SHARED, TACP_KERNEL, TACP_KERNEL, TACP_SHARED }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(&nvar2), _kernel_almhdr_ALM3, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_almhdr_ALM4, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_almhdr_ALM5, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(SEM1), _kernel_almhdr_ALM6, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(FLG1), _kernel_almhdr_ALM7, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(DTQ1), _kernel_almhdr_ALM8, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_almhdr_ALM9, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 },
	{ (TA_NULL), (intptr_t)(TASK1), _kernel_almhdr_ALM10, { TACP_KERNEL, TACP_KERNEL, TACP_SHARED, TACP_KERNEL }, &_kernel_dominib_kernel, 1, 0x1 }
};
...
void _kernel_inthdr_65545(void) __attribute__((section(".kernel_code_CLS_PRC1")));
...
const INHINIB _kernel_inhinib_table[TNUM_DEF_INHNO] = {
	...
	{ (INHNO1), (TA_NULL), (FP)(INT_ENTRY(INHNO1, int1_handler)), 1 },
	{ (65545), (TA_NULL), (FP)(INT_ENTRY(65545, _kernel_inthdr_65545)), 1 }
};
...
const EXCINIB _kernel_excinib_table[TNUM_DEF_EXCNO] = {
	{ (CPUEXC1), (TA_NULL), (FP)(EXC_ENTRY(CPUEXC1, cpuexc1_handler)), 1, 0x1U },
	{ (CPUEXC2), (TA_NULL), (FP)(EXC_ENTRY(CPUEXC2, cpuexc2_handler)), 1, 0x1U }
};
...
const ACVCT _kernel_sysstat1_acvct = { TACP_SHARED, TACP_KERNEL, TACP_KERNEL, TACP_SHARED };
const ACVCT _kernel_sysstat2_acvct = { TACP_SHARED, TACP_KERNEL, TACP_KERNEL, TACP_KERNEL };
