 ...
 *  の責任を負わない．
 * 
 *  $Id: kernel.h 1083 2023-04-11 08:42:08Z ertl-hiro $
 */
...
#else /* TA_RWDATASEC */
#define TA_DATASEC			(TA_RWDATASEC|TA_MEMINI)
#define TA_BSSSEC			(TA_RWDATASEC|TA_MEMZERO)
#define TA_NOINITSEC		(TA_RWDATASEC)
#endif /* TA_RWDATASEC */
#ifndef TA_LOSEC
 ...
 */
#define SCHEDNO(prcid, domid)	((((uint_t) domid) << 16) | ((prcid) & 0xffffU))
