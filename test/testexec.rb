...
#  の責任を負わない．
# 
#  $Id: testexec.rb 1071 2023-01-18 06:07:39Z ertl-hiro $
# 
...
TEST_SPEC = {
  ...
  # 機能テストプログラムのユーザドメインでの実行
  "cpuexc5u"  => { SRC: "test_cpuexc5", CFG: "test_cpuexc5u" },
  "cpuexc6u"  => { SRC: "test_cpuexc6", CFG: "test_cpuexc6u" },
  "cpuexc7u"  => { SRC: "test_cpuexc7", CFG: "test_cpuexc7u" },
  "cpuexc8u"  => { SRC: "test_cpuexc8", CFG: "test_cpuexc8u" },
  "cpuexc9u"  => { SRC: "test_cpuexc9", CFG: "test_cpuexc9u" },
  "cpuexc10u" => { SRC: "test_cpuexc10", CFG: "test_cpuexc10u" },
  "sysstat1u" => { SRC: "test_sysstat1", CFG: "test_sysstat1u" },
  ...
  "spinlock1-emu"  => { SRC: "test_spinlock1", DEFS: "-DTMAX_NATIVE_SPN=0" },
  "spinlock1-both" => { SRC: "test_spinlock1", DEFS: "-DTMAX_NATIVE_SPN=1" },
  ...
  # 性能評価プログラムのユーザドメインでの実行
  "perf0u" => { TARGET: 1, SRC: "perf0", CFG: "perf0u",
						CDL: "perf_pf", SYSOBJ: "histogram",
						NK_DEFS: "-DHIST_INVALIDATE_CACHE" },
  "perf1u" => { TARGET: 1, SRC: "perf1", CFG: "perf1u",
						CDL: "perf_pf", SYSOBJ: "histogram",
						NK_DEFS: "-DHIST_INVALIDATE_CACHE" },
