 ...
 * 
 *  Copyright (C) 2012-2022 by Embedded and Real-Time Systems Laboratory
 ...
 *  の責任を負わない．
 * 
 *  $Id: test_extsvc1.c 968 2022-10-23 13:36:23Z ertl-hiro $
 */
 ...
 *		ipm(TIPM_ENAALL)
 *		cal_svc(TFN_EXTSVC3, 0, 0, 0, 0, 0) -> E_NOMEM_OR_SYS	... (F-4)
...
/*
 *  cal_svcでE_NOMEMが検出できない実装（シミュレーション環境を想定）で
 *  は，E_NOMEMではなく，E_SYSが返る．
 */
#ifdef TOPPERS_NOSUPPORT_CALSVC_NOMEM
#define E_NOMEM_OR_SYS	E_SYS
#else /* TOPPERS_NOSUPPORT_CALSVC_NOMEM */
#define E_NOMEM_OR_SYS	E_NOMEM
#endif /* TOPPERS_NOSUPPORT_CALSVC_NOMEM */
...
task1(EXINF exinf)
{
	...
	ercd = cal_svc(TFN_EXTSVC3, 0, 0, 0, 0, 0);
	check_ercd(ercd, E_NOMEM_OR_SYS);
