...
#  の責任を負わない．
# 
#  $Id: gensvc.rb 943 2022-10-21 02:03:10Z ertl-hiro $
# 
...
#if defined(TOPPERS_SVC_CALL) || defined(TOPPERS_SVC_CALL_KERNEL)
...
#endif /* defined(TOPPERS_SVC_CALL) || defined(TOPPERS_SVC_CALL_KERNEL) */
