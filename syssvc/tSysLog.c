 ...
 *  の責任を負わない．
 * 
 *  $Id: tSysLog.c 3234 2021-10-24 13:13:34Z ertl-hiro $
 */
...
{
	cPutLog_putChar(c);
	// while((sil_rew_mem((XUARTPS_SR(SIO_XUARTPS_BASE))) & XUARTPS_SR_TXFULL));
  	// sil_wrw_mem(XUARTPS_FIFO(SIO_XUARTPS_BASE), (uint32_t) c);
