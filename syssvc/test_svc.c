 ...
 *  の責任を負わない．
 * 
 *  $Id: test_svc.c 950 2022-10-21 10:07:59Z ertl-hiro $
 */
...
static uint_t	barrier_tnum_prcid;			/* 同期対象のプロセッサ数 */
 ...
 */
void
_set_barrier_numprc(uint_t numprc)
{
...
ER_UINT
extsvc_set_barrier_numprc(intptr_t numprc, intptr_t par2, intptr_t par3,
							intptr_t par4, intptr_t par5, ID cdmid)
{
	_set_barrier_numprc((uint_t) numprc);
	return(E_OK);
