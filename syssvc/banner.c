 ...
 *  の責任を負わない．
 * 
 *  $Id: banner.c 1076 2023-03-14 05:45:09Z ertl-hiro $
 */
...
static const char banner_prc[] = "Processor %d is started.";

/*
 *  カーネル起動メッセージの出力（マスタプロセッサのみ）
 */
void
...
/*
 *  カーネル起動メッセージの出力（全プロセッサ）
 */
void
print_banner_prc(EXINF exinf)
{
	ID	prcid;
