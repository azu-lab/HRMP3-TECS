 ...
 *  の責任を負わない．
 * 
 *  $Id: test_svc.h 950 2022-10-21 10:07:59Z ertl-hiro $
 */
...
#ifndef SSZ_SET_BARRIER_NUMPRC
#define SSZ_SET_BARRIER_NUMPRC		1024
#endif /* SSZ_SET_BARRIER_NUMPRC */
...
extern void _set_barrier_numprc(uint_t numprc);
...
{
	(void) cal_svc(TFN_SET_BARRIER_NUMPRC, (intptr_t) numprc, 0, 0, 0, 0);
}
...
#define set_barrier_numprc			_set_barrier_numprc
...
extern ER_UINT	extsvc_test_barrier(intptr_t phase, intptr_t par2,
									intptr_t par3, intptr_t par4,
									intptr_t par5, ID cdmid) throw();
extern ER_UINT	extsvc_set_barrier_numprc(intptr_t numprc, intptr_t par2,
									intptr_t par3, intptr_t par4,
									intptr_t par5, ID cdmid) throw();
