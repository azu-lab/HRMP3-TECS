...
Inline ER
eTask_migrateAndActivate(tTask_IDX idx, ID prcid)
{
    CELLCB  *p_cellcb = GET_CELLCB(idx);
    return(mact_tsk(ATTR_id, prcid));
}

Inline ER
eTask_migrate(tTask_IDX idx, ID prcid)
{
    CELLCB  *p_cellcb = GET_CELLCB(idx);
    return(mig_tsk(ATTR_id, prcid));
}

/*
Inline ER
eTask_changeSubPriority(tTask_IDX idx, uint_t subPriority)
{
    CELLCB  *p_cellcb = GET_CELLCB(idx);
    return(chg_spr(ATTR_id, subPriority));
}
*/
