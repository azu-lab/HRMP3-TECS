 ...
 *  の責任を負わない．
 * 
 *  $Id: task_term.c 898 2022-06-21 12:30:39Z ertl-hiro $
 */
...
dis_ter(void)
{
	...
	CHECK_ACPTN(sysstat2_acvct.acptn1, selfdom);	/*［NGKI3764］*/
...
ena_ter(void)
{
	...
	CHECK_ACPTN(sysstat2_acvct.acptn1, selfdom);	/*［NGKI3765］*/
...
ter_tsk(ID tskid)
{
	...
	p_tcb = get_tcb(tskid);
	CHECK_ACPTN(p_tcb->p_tinib->acvct.acptn2, selfdom);	/*［NGKI3508］*/
	CHECK_ACPTN(sysstat2_acvct.acptn3, selfdom);
