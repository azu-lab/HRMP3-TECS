 ...
 *  の責任を負わない．
 * 
 *  $Id: task.h 926 2022-09-23 12:18:03Z ertl-hiro $
 */
 ...
 *  ら，プロセッサで実行すべきタスクを選択する．
 *
 *  この関数を，他プロセッサのPCBをパラメータとして呼び出す場合には，
 *  呼び出す前にmemory_barrierを呼び出さなければならない．
 */
extern void update_schedtsk(PCB *p_pcb);
 ...
 */
Inline void
update_schedtsk_dsp(PCB *p_my_pcb, PCB *p_pcb)
{
	TCB		*p_prev_schedtsk;
