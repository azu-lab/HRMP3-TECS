 ...
 *  の責任を負わない．
 * 
 *  $Id: time_manage.c 898 2022-06-21 12:30:39Z ertl-hiro $
 */
...
set_tim(SYSTIM systim)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn3, selfdom);	/*［NGKI3566］*/
...
get_tim(SYSTIM *p_systim)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn4, selfdom);	/*［NGKI2352］*/
...
adj_tim(int32_t adjtim)
{
	...
	CHECK_PAR(TMIN_ADJTIM <= adjtim && adjtim <= TMAX_ADJTIM);
													/*［NGKI3584］*/
	CHECK_ACPTN(sysstat1_acvct.acptn3, selfdom);	/*［NGKI3585］*/
