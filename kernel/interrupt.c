 ...
 *  の責任を負わない．
 * 
 *  $Id: interrupt.c 1036 2022-12-17 03:47:23Z ertl-hiro $
 */
...
dis_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn2, get_selfdom());	/*［NGKI3084］*/
...
ena_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn2, get_selfdom());	/*［NGKI3097］*/
...
clr_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn2, get_selfdom());	/*［NGKI3922］*/
...
ras_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn2, get_selfdom());	/*［NGKI3934］*/
...
prb_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn4, get_selfdom());	/*［NGKI3946］*/
...
chg_ipm(PRI intpri)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn2, selfdom);	/*［NGKI3110］*/
...
get_ipm(PRI *p_intpri)
{
	...
	CHECK_ACPTN(sysstat1_acvct.acptn4, selfdom);	/*［NGKI3118］*/
